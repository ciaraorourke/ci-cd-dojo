    ...
    stages {
        ...
        stage('Docker Deploy QA') {
            ...
            steps {
                ...
                sh "docker run -d -p 8081:8085 --name ninja-belt-qa -h ninja-belt-qa --network dd-network --ip 10.0.0.11 ${env.DOCKER_HUB_ACCOUNT}/${env.APPLICATION_NAME}-qa:${env.APPLICATION_TAG_VERSION}"
